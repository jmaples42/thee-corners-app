...
const s = StyleSheet.create({
  ...
  successMark: { fontFamily: 'PlayfairDisplay_700Bold', fontSize: 64, color: Colors.rust, marginBottom: 16 },
  successTitle: { fontFamily: 'PlayfairDisplay_700Bold', fontSize: 28, color: Colors.cream, marginBottom: 8 },
  successSub: { fontFamily: 'SpaceMono_400Regular', fontSize: 10, color: Colors.amber, letterSpacing: 3 },
  navBar: {
  ...
  navCorner: { fontFamily: 'SpaceMono_400Regular', fontSize: 9, color: Colors.amber, letterSpacing: 1, marginTop: 2 },
  scroll: { flex: 1 },
  section: { paddingHorizontal: 20, marginTop: 24 },
  label: { fontFamily: 'SpaceMono_400Regular', fontSize: 9, color: Colors.amber, letterSpacing: 3, marginBottom: 6 },
  hint: { fontFamily: 'System', fontSize: 12, color: Colors.mutedText, marginBottom: 10 },
  linkInput: {
  ...
  previewArtText: { fontFamily: 'PlayfairDisplay_700Bold', fontSize: 20, color: Colors.olive },
  previewMeta: { flex: 1 },
  previewTitle: { fontFamily: 'PlayfairDisplay_400Regular', fontSize: 14, color: Colors.cream },
  previewSource: { fontFamily: 'SpaceMono_400Regular', fontSize: 9, color: Colors.amber, letterSpacing: 1, marginTop: 4 },
  noteInput: {
    borderWidth: 1, borderColor: Colors.border, backgroundColor: Colors.cardBg,
    padding: 14, fontFamily: 'System', fontSize: 14, color: Colors.cream,
    minHeight: 110, lineHeight: 22,
  },
  charCount: { fontFamily: 'SpaceMono_400Regular', fontSize: 10, color: Colors.mutedText, textAlign: 'right', marginTop: 4 },
  tagRow: {
  ...
  tagLabel: { fontFamily: 'PlayfairDisplay_400Regular', fontSize: 16, color: Colors.mutedText },
  tagLabelActive: { color: Colors.cream },
  tagDesc: { fontFamily: 'System', fontSize: 12, color: Colors.mutedText, marginTop: 2 },
  postBtn: {
  ...
  postBtnText: { fontFamily: 'SpaceMono_400Regular', fontSize: 12, color: Colors.cream, letterSpacing: 3 },
});
