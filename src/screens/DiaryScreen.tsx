...
const dg = StyleSheet.create({
  ...
  groupLabel: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 8, color: Colors.amber, letterSpacing: 3, marginBottom: 12 },
  card: { backgroundColor: Colors.cardBg, borderLeftWidth: 2, borderLeftColor: Colors.rust, padding: 14, marginBottom: 10 },
  cardTop: { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 8 },
  trackInfo: { flex: 1 },
  trackTitle: { fontFamily: 'BigShouldersDisplay_900Black', fontSize: 15, color: Colors.cream },
  source: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 9, color: Colors.olive, letterSpacing: 1, marginTop: 2 },
  shareBtn: { borderWidth: 1, borderColor: Colors.border, paddingHorizontal: 10, paddingVertical: 5, marginLeft: 12 },
  shareBtnText: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 9, color: Colors.mutedText, letterSpacing: 1 },
  note: { fontFamily: 'Inter_400Regular', fontSize: 13, color: Colors.cream, lineHeight: 20, opacity: 0.8, marginBottom: 8 },
  timestamp: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 9, color: Colors.mutedText },
});
...
const s = StyleSheet.create({
  ...
  avatarText: { fontFamily: 'BigShouldersDisplay_900Black', fontSize: 28, color: Colors.amber },
  profileInfo: { flex: 1 },
  displayName: { fontFamily: 'BigShouldersDisplay_900Black', fontSize: 20, color: Colors.cream, marginBottom: 8 },
  ...
  sectionLabel: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 8, color: Colors.amber, letterSpacing: 3, marginBottom: 12 },
  ...
  badgeLabel: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 8, color: Colors.cream, letterSpacing: 1, textAlign: 'center' },
  ...
  emptyText: { fontFamily: 'Inter_400Regular', fontSize: 16, color: Colors.mutedText },
  ...
  signOutText: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 9, color: Colors.mutedText, letterSpacing: 2 },
});
